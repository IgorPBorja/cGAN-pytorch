...
d_hidden_layers = [512, 1024, 2048, 2048, 256]
...
## TODO switch to our dataset
dataset = datasets.MNIST(root=root, 
                         transform=transforms.Compose([transforms.ToTensor(), transforms.Resize(img_size, antialias=None)]), 
                         train=True, download=True)
"""
dataset = RadiographSexSet(annotations_file = os.path.join(root, "pan-radiographs.csv"),
